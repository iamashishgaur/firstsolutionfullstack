...
export default function Footer() {
  return (
    <>
      <section className="py-7 bg-gray-50 sm:pt-16 dark:bg-[#020817] dark:text-white border-y">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <div className="flex gap-4 items-center">
                <Image
                  ...
                  height={50}
                />
                <h3 className="text-2xl font-semibold">First Solution</h3>
              </div>
              ...
              <ul className="flex items-center space-x-3 mt-9 dark:text-white">
                <li className="dark:text-white">
                  <Link
                    href="#"
                    title=""
                    className="flex items-center justify-center text-white transition-all duration-200  rounded-full w-7 h-7 dark:text-white "
                  >
                    <svg
                      className="w-4 h-4"
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              ...
              <div className="space-y-4">
                <span className="flex gap-4 mt-6 justify-start items-center  ">
                  <p>
                ...
                <span className="flex gap-4 mt-6 justify-start items-center  ">
                  <CiMail size={23} />
                  <p>first_solution@rediffmail.com</p>
                </span>
                <span className="flex  gap-4 justify-start items-center ">
                  <MdOutlineWifiCalling3 size={23} />
                  <p>+91 9320020421 / 8424000595</p>
                </span>
                <span className="flex gap-4 justify-start items-center ">
                  <LuClock9 size={23} />
                  <p>10am-6:30pm Mon-Sat</p>
                </span>
              </div>
            </div>
          </div>
          ...
          <p className="text-sm text-center ">
            © Copyright 2024, All Rights Reserved by First Solution
          </p>
        </div>
      </section>
    </>
