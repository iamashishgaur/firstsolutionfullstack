...
function TestimonialCard() {
  return (
    <>
      <div className="offcss">
        <div className="items-center bg-gray-50  rounded-lg shadow sm:flex dark:bg-gray-800  dark:border-gray-700">
          <Link href="#">
            <Image
              className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
              src="/images/team/JayPatel.jpg"
              alt="Bonnie Avatar"
              width={300}
              height={300}
            />
          ...
          <div className="p-5 text-start">
            ...
            <ul className="flex space-x-4 sm:mt-0 relative">
              <li>
                <Link
                  href="#"
...
export default function Testimonial() {
  return (
    <>
      <section className="bg-white  dark:bg-[#020817] px-20 md:px-10 mt-10">
              ...
              <CarouselContent>
                {Array.from({ length: 5 }).map((_, index) => (
                  <CarouselItem key={index}>
                    <div className="p-1 flex gap-4 md:w-ful">
                      <TestimonialCard />
                      <TestimonialCard />
                    </div>
                  </CarouselItem>
